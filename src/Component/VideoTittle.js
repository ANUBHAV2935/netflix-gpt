...
const VideoTittle = ({title,overview}) => {
  ...
  return (
    <div className='my-60 w-[38%] mx-24 absolute bg-gradient-to-r from-black'>
      ...
      <div className='my-8'>
        ...
        <button className='bg-gray-500 px-8 py-3 rounded-sm text-white mx-6 opacity-90'> ℹ More info</button>
      </div>
    </div>
  )
}
